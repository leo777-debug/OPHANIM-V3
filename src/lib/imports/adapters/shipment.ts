...
export const shipmentImportAdapter: ImportAdapter<ShipmentInput> = {
  ...
  columns: [
    ...
    { key: 'mmsiNumber', label: 'MMSI number', aliases: ['mmsi number', 'mmsi'] },
    ...
    { key: 'transshipmentPorts', label: 'Transshipment ports', aliases: ['transshipment ports', 'transshipment port', 'via ports'] },
    { key: 'customerId', label: 'Customer ID', aliases: ['customer id', 'client id'] },
    { key: 'customerContact', label: 'Customer contact', aliases: ['customer contact', 'client contact'] },
