...
import { ImportError, type ImportColumnMapping, type ImportPreview, type ImportPreviewRow } from '@/lib/imports/types';
...
export const SHIPMENT_IMPORT_FIELDS = shipmentImportAdapter.columns.map((column) => column.key) as readonly string[];
