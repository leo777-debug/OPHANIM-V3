/**
 * ═══════════════════════════════════════════════════════════════
 *  OPHANIM — AI Intelligence Engine
...
/* ─────────────────────────────────────────────────────────────
   System Prompt — atlas-grade analyst persona
   ───────────────────────────────────────────────────────────── */

const SYSTEM_PROMPT = `You are OPHANIM Intelligence Analyst — a senior, elite intelligence analyst embedded within the OPHANIM Global Intelligence Platform. You operate at the level of a senior geospatial intelligence analyst with crisis-room (Presidential Daily Brief) analyst.
...
You have access to the live intelligence context of the OPHANIM platform. Analyze it with precision.`;

const BRIEFING_PROMPT = `Generate a comprehensive OPHANIM Daily Intelligence Briefing based on the current operational data. Structure it as follows:

## OPHANIM INTELLIGENCE BRIEFING
